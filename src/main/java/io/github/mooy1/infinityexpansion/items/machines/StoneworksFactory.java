...
public final class StoneworksFactory extends AbstractMachineBlock implements RecipeDisplayItem, NotHopperable {
    ...
    private enum Choice {
        ...
        FURNACE(new CustomItemStack(Material.FURNACE, "&8烧制", "", "&f圆石 &8=> &f石头", "&f沙子 &8=> &f玻璃", "&f石砖 &8=> &f裂石砖", "", "&7 > 点击切换"),
        ...
        COMPACT(new CustomItemStack(Material.PISTON, "&8压实", "", "&f石头 &8=> &f石砖", "&f花岗岩 &8=> &f磨制花岗岩", "&f闪长岩 &8=> &f磨制闪长岩", "&f安山岩 &8=> &f磨制安山岩", "&f沙子 &8=> &f沙石", "", "&7 > 点击切换"),
