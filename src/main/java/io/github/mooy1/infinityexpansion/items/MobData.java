...
public final class MobData {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new MobDataCard("Zombie", "僵尸", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("Slime", "史莱姆", MobDataTier.NEUTRAL, new ItemStack[] {
        ...
        new MobDataCard("Magma Cube", "岩浆怪", MobDataTier.NEUTRAL, new ItemStack[] {
        ...
        new MobDataCard("Cow", "牛", MobDataTier.PASSIVE, new ItemStack[] {
        ...
        new MobDataCard("Sheep", "羊", MobDataTier.PASSIVE, new ItemStack[] {
        ...
        new MobDataCard("Spider", "蜘蛛", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("Skeleton", "骷髅", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("Wither Skeleton", "凋零骷髅", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("Endermen", "末影人", MobDataTier.ADVANCED, new ItemStack[] {
        ...
        new MobDataCard("Creeper", "苦力怕", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("Guardian", "守卫者", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("Chicken", "鸡", MobDataTier.PASSIVE, new ItemStack[] {
        ...
        new MobDataCard("Iron Golem", "铁傀儡", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("Blaze", "烈焰人", MobDataTier.ADVANCED, new ItemStack[] {
        ...
        new MobDataCard("Wither", "凋灵", MobDataTier.MINI_BOSS, new ItemStack[] {
        ...
        new MobDataCard("Ender Dragon", "末影龙", MobDataTier.BOSS, new ItemStack[] {
        ...
        new MobDataCard("Bee", "蜜蜂", MobDataTier.NEUTRAL, new ItemStack[] {
        ...
        new MobDataCard("Villager", "村民", MobDataTier.ADVANCED, new ItemStack[] {
        ...
        new MobDataCard("Witch", "女巫", MobDataTier.ADVANCED, new ItemStack[] {
